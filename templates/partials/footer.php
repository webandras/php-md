<footer class="footer">
    ...
    <ul class="footer--nav">
        <li>
            <a href="<?= BASE_URL . get_language_segment($current_language_code) ?>" <?php echo set_active_page_link($template_name) ?>>
                <?= $home_text ?>
            </a>
        </li>
        <li>
            <a href="<?= BASE_URL . get_language_segment($current_language_code) ?>archive"<?php echo set_active_page_link($template_name, 'archive') ?>>
                <?= $archive_text ?>
            </a>
        </li>
    </ul>
